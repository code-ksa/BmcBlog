...
### 0. `Verify-Current-Structure.ps1` ⭐
**الوظيفة:** التحقق من البنية الحالية في Sitecore قبل التنفيذ

**الفحوصات:**
- ✅ التحقق من وجود Templates وعرض IDs
- ✅ التحقق من المسار القديم (SA/Blog) والجديد (BmcBlog)
- ✅ عد التصنيفات والكتّاب والمقالات
- ✅ التحقق من Media Library
- ✅ التحقق من تكامل Site مع Media Library
- ✅ توصيات تلقائية بناءً على الوضع الحالي

**متى تستخدمه:**
- قبل تشغيل أي سكريبت آخر لفهم الوضع الحالي
- للتحقق من نجاح تنفيذ السكريبتات الأخرى
- لاكتشاف أي تعارضات أو عناصر مفقودة

**المخرجات:**
- تقرير مفصل بالعناصر الموجودة/المفقودة
- إحصائيات المحتوى
- توصيات بالخطوات التالية
...
### الخطوة 0️⃣: التحقق من الوضع الحالي (موصى به)
```powershell
...
**النتيجة المتوقعة:**
- تقرير شامل بالعناصر الموجودة والمفقودة
- إحصائيات المحتوى الحالي
- توصيات بالخطوات التالية

**الفائدة:**
- فهم الوضع الحالي قبل إجراء أي تغييرات
- تجنب التعارضات
- معرفة ما إذا كنت بحاجة لتشغيل سكريبتات معينة

**مثال على المخرجات:**
```
✓ Site Template : {F2FD4169-6FF9-4A5B-826C-63A2F091E91E}
✗ Blog Post Template : غير موجود
✓ موقع BmcBlog موجود
⚠ كلا المسارين موجودان (القديم والجديد)
→ قم بتشغيل: Create-BMC-Blog-Templates.ps1
```
